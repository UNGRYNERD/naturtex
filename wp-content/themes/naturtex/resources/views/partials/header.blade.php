...
<section class="super-menu">
  ...
  <div class="super-menu__social">
    ...
    <a target="_blank" href="{{ get_theme_mod('ungrynerd_contact_linkedin') }}"
      class="super-menu__social-link super-menu__social-link--linkedin">
      <img src="@asset('images/linkedin.png')" alt="LinkedIn">
    </a>
    @endif
    @if (get_theme_mod('ungrynerd_contact_instagram'))
    <a target="_blank" href="{{ get_theme_mod('ungrynerd_contact_instagram') }}"
      class="super-menu__social-link super-menu__social-link--instagram">
      <img src="@asset('images/instagram.png')" alt="Instagram">
    </a>
    @endif
    @if (get_theme_mod('ungrynerd_contact_pinterest'))
    <a target="_blank" href="{{ get_theme_mod('ungrynerd_contact_pinterest') }}"
      class="super-menu__social-link super-menu__social-link--pinterest">
      <img src="@asset('images/pinterest.png')" alt="Pinterest">
    </a>
    @endif
    @if (get_theme_mod('ungrynerd_contact_facebook'))
    <a target="_blank" href="{{ get_theme_mod('ungrynerd_contact_facebook') }}"
      class="super-menu__social-link super-menu__social-link--facebook">
