		...
		final class Woo_Variation_Swatches_Pro {
			...
			public function enqueue_scripts() {
				...
				if ( woo_variation_swatches()->get_option( 'enable_single_variation_preview' ) || woo_variation_swatches()->get_option( 'disable_threshold' ) ):
					...
					wp_register_script( 'wc-add-to-cart-variation', $this->assets_uri( "/js/add-to-cart-variation{$suffix}.js" ), array( 'jquery', 'wp-util' ), $this->version(), ! $is_defer );
				endif;
				
				
				wp_enqueue_script( 'woo-variation-swatches-pro', $this->assets_uri( "/js/frontend-pro{$suffix}.js" ), array( 'jquery' ), $this->version(), ! $is_defer );
